...
void Cube::ShowCube() const
{
    ...
    cout
            << " " << GetColor(m_Left >> 28) << " " << GetColor(m_Left >> 24 & 0x0F) << " " << GetColor(m_Left >> 20 & 0x00F)
            << "  " << GetColor(m_Front >> 28) << " " << GetColor(m_Front >> 24 & 0x0F) << " " << GetColor(m_Front >> 20 & 0x00F)
            << "  " << GetColor(m_Right >> 28) << " " << GetColor(m_Right >> 24 & 0x0F) << " " << GetColor(m_Right >> 20 & 0x00F)
            << "  " << GetColor(m_Back >> 28) << " " << GetColor(m_Back >> 24 & 0x0F) << " " << GetColor(m_Back >> 20 & 0x00F) << endl;

    cout
            << " " << GetColor(m_Left & 0x0000000F) << " " << 'R' << " " << GetColor(m_Left >> 16 & 0x000F)
            << "  " << GetColor(m_Front & 0x0000000F) << " " << 'G' << " " << GetColor(m_Front >> 16 & 0x000F)
            << "  " << GetColor(m_Right & 0x0000000F) << " " << 'O' << " " << GetColor(m_Right >> 16 & 0x000F)
            << "  " << GetColor(m_Back & 0x0000000F) << " " << 'B' << " " << GetColor(m_Back >> 16 & 0x000F) << endl;

    cout
            << " " << GetColor(m_Left >> 4 & 0x000000F) << " " << GetColor(m_Left >> 8 & 0x00000F) << " " << GetColor(m_Left >> 12 & 0x0000F)
            << "  " << GetColor(m_Front >> 4 & 0x000000F) << " " << GetColor(m_Front >> 8 & 0x00000F) << " " << GetColor(m_Front >> 12 & 0x0000F)
            << "  " << GetColor(m_Right >> 4 & 0x000000F) << " " << GetColor(m_Right >> 8 & 0x00000F) << " " << GetColor(m_Right >> 12 & 0x0000F)
            << "  " << GetColor(m_Back >> 4 & 0x000000F) << " " << GetColor(m_Back >> 8 & 0x00000F) << " " << GetColor(m_Back >> 12 & 0x0000F) << endl;
